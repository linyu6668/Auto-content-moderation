...
for i=1:Len
    ...
    a=imread(img(i).name);
    temp=rgb2gray(a);
    result=ordfilt2(temp,9,ones(3,3));

    cd '/xxx/desktop/datasets/highfreq/fire';
    Name = [num2str(i), '.jpg'];
    imwrite(result, Name);
    cd (path);
end
...
for i=1:Len2
    ...
    result2=ordfilt2(temp2,9,ones(3,3));
    cd '/xxx/desktop/datasets/highfreq/candle';
    Name2 = [num2str(i), '.jpg'];
...
for i=1:Len3
    ...
    temp3=rgb2gray(a);
    result3=ordfilt2(temp3,9,ones(3,3));
    cd '/xxx/desktop/datasets/highfreq/not fire';
    Name3 = [num2str(i), '.jpg'];
